        ...
        >
          ...
          <div>
            <p className="text-md p-2 tracking-wide leading-6">
              ...
              Ushuaia es por avión. El Aeropuerto de Ushuaia recibe vuelos diarios desde Buenos Aires y otras ciudades importantes de Argentina. El vuelo desde Buenos Aires tiene una duración aproximada de 3 horas y media.
            </p>
            <p className="text-md p-2 tracking-wide leading-6">
              • <b>Vía Terrestre:</b> Se puede llegar a Ushuaia en coche o
              autobús. Desde Buenos Aires, la ruta más común es la Ruta Nacional
